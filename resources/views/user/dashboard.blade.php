                ...
                <div class="col-md-10">
                    <div class="card-body">
                        <h5 class="card-title">{{ auth()->user()->name }}
                            <a href="#" class="text-success mt-5" data-bs-toggle="modal" data-bs-target="#edit-{{ auth()->user()->id }}"><i class="fa fa-edit h4"></i></a>
                        </h5>
    ...
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col-md-2 d-flex justify-content-end ms-auto">
                <a href="{{route('user.download')}}" class="btn btn-danger mt-3 mb-5 border-0">Slip Gaji</a>
            </div>
        </div>
    </div>
